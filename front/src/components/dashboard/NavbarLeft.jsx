...
import '../../assets/styles/dashboard/navbarLeft.sass'
            ...
            <ul className="sidebar-nav">
                ...
                <li className="sidebar-item active">
                    <a href="#" className="sidebar-link" aria-expanded="false">
                        <FontAwesomeIcon className="fa-fw" icon={['fas', 'home']}/>
                ...
                <li className="sidebar-item">
                    <a href="#request" data-toggle="collapse" className="sidebar-link collapsed" aria-expanded="false">
                        <FontAwesomeIcon className="fa-fw" icon={['fas', 'check-square']}/>
                ...
                <li className="sidebar-item">
                    <a href="#" className="sidebar-link collapsed" aria-expanded="false">
                        <FontAwesomeIcon className="fa-fw" icon={['fas', 'clipboard-list']}/>
                ...
                <li className="sidebar-item">
                    <a href="#" className="sidebar-link" aria-expanded="false">
                        <FontAwesomeIcon className="fa-fw" icon={['fas', 'calendar-alt']}/>
                ...
                <li className="sidebar-item">
                    <a href="#prestamo" data-toggle="collapse" className="sidebar-link collapsed" aria-expanded="false">
                        <FontAwesomeIcon className="fa-fw" icon={['fas', 'laptop']}/>
                ...
                <li className="sidebar-item">
                    <a href="#inventory" data-toggle="collapse" className="sidebar-link collapsed"
                       aria-expanded="false">
                        <FontAwesomeIcon className="fa-fw" icon={['fas', 'boxes']}/>
                ...
                <li className="sidebar-item">
                    <a href="#maintenance" data-toggle="collapse" className="sidebar-link collapsed"
                       aria-expanded="false">
                        <FontAwesomeIcon className="fa-fw" icon={['fas', 'tools']}/>
